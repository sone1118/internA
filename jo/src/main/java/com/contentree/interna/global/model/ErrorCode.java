...
public enum ErrorCode {
	// JWT
	BLACK_REFRESH(400, "AUTH_001", "사용할 수 없는 Refresh Token"), BLACK_ACCESS(400, "AUTH_002", "사용할 수 없는 Access Token"),
	...
	// Mypage
	ALREADY_CERTIFIED(400, "MYPAGE_001", "이미 인증된 임직원."), ALREADY_USED(400, "MYPAGE_002", "이미 인증에 사용된 아이디"),
