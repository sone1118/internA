...
public class JwtTokenUtil {
	...
	public String createAccessToken(long userSeq) {
		...
		String jwts = Jwts.builder().setSubject("Access Token").claim("userSeq", userSeq) // userSeq 저장
	...
	public String createRefreshToken() {
		...
		String jwts = Jwts.builder().setSubject("Refresh Token").setExpiration(expires) // 만료시간
				.setIssuer("Jo") // 발행자
				.signWith(key, SignatureAlgorithm.HS512) // 암호화
				.compact();
